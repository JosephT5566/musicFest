...
interface ShowItem extends IArtistV2 {
	layer: number;
...
export default function TimeLineOfDayV2(props: TimeLineOfDayV2Props) {
	...
	const allArtists: ShowItem[] = stages.flatMap((stage, stageIndex) =>
		stage.artistIds
			.map((artistId) => {
				...
				return {
					...
					itemColor: palette.stage[stageIndex as keyof typeof palette.stage],
					layer: 0,
					overlappingCount: 1,
				};
			})
